$(function(){
	new  Slideshow({
		boxId:"#box",
		imgs:["img/001.jpg","img/002.jpg","img/003.jpg","img/004.jpg","img/005.jpg"],
		width:1260,
		height:680,
		timeSpace:3000,
		fadeInOutTime:2000,
...
Slideshow.prototype.initUI = function(){
	...
	//2、所有按钮的创建
	let ulliStr = "<ul style='position:absolute;right:50%;top:60%;z-index:999;display:flex;justify-content:space-between'>";
